...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.88e0a0bea18ddfaa0c668a915720b93a58f554b57ff0a3b46d011daacbb25a95.js',function(){input.required=false;search();});}
