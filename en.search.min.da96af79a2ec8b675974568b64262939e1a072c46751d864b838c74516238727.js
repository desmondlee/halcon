...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3b1c777e8697df1052f710d21291817d5446fbe9be4d3671ffd07936c68a389e.js',function(){input.required=false;search();});}
