...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.671fd6a03b9760eb478c40cc3ce334a013068095371794d9f032aa0537aae822.js',function(){input.required=false;search();});}
