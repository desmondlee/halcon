...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.012058200b3dfb908948385e8423784cd65a93ea2af8cb8a088f78a0b7ef63d4.js',function(){input.required=false;search();});}
